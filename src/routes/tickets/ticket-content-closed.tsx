...
const messages = [
    { id: 1, user: "Ash Ketchup", time: "4:34 PM", profile: ash, message: "I'm closing this ticket." },
    { id: 2, user: "Wile E. Coyote", time: "4:34 PM", profile: wile, message: "I refuse." },
    { id: 3, user: "Ash Ketchup", time: "4:34 PM", profile: ash, message: "That isn't a valid order number. Could you check the order number again?" },
    { id: 4, user: "Wile E. Coyote", time: "4:30 PM", profile: wile, message: "2que982uq94eu29qu349q" },
    { id: 5, user: "Ash Ketchup", time: "4:22 PM", profile: ash, message: "Of course, can I get the order number?" },
    { id: 6, user: "Wile E. Coyote", time: "4:18 PM", profile: wile, message: "My SUPERPC9000 never arrived, can I have some assistance?" },
]

function TicketContentClosed() {
...
export default TicketContentClosed;