            ...
            <div className="flex flex-col gap-y-6 border rounded-lg p-4">
                {sets.map(item => (
                    <div className="flex flex-col">
                        ...
                        {item.title === "Collaborative" &&
                            <div className="flex flex-row items-center gap-x-2.5 font-semibold">
                                <div>{item.title}</div>
                                <Users size={20} />
                            </div>
                        }
                ...
                <DialogTrigger>
                    <Button className="text-sm font-medium text-center bg-black hover:bg-stone-700 text-white py-1.5 rounded">
                        Create New List
                    </Button>
                    <ListModal />
                </DialogTrigger>
