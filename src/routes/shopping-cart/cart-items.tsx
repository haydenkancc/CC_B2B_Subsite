                        ...
                        <div className="flex flex-row gap-x-0.5">
                            ...
                            <div className="flex flex-col gap-y-1">
                                ...
                                <div className="flex flex-wrap items-center gap-x-5 gap-y-2.5">
                                    ...
                                    <div className="text-sm text-blue-700 hover:underline cursor-pointer">Remove</div>
                                    <div className="text-sm text-blue-700 hover:underline cursor-pointer">Save for Later</div>
                                </div>
                            </div>
                        </div>
