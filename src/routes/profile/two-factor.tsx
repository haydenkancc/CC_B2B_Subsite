                        ...
                        {twoSelect === "email" && emailVerification === 'email-no' && (
                            <div>
                                ...
                                <div className="flex flex-row items-center gap-x-2.5">
                                    ...
                                    <button className="text-sm p-2.5 border hover:bg-stone-700 focus:outline-none rounded bg-black text-white" onClick={() => setEmailVerification('email-yes')}>Send Authentication Code</button>
                                </div>
                            </div>
                        )}
                        {twoSelect === "email" && emailVerification === 'email-yes' && (
                            <div>
                                ...
                                <div className="flex flex-row items-center gap-x-2.5">
                                    ...
                                    <button className="text-sm p-2.5 border hover:bg-stone-700 focus:outline-none rounded bg-black text-white">Send Authentication Code</button>
                                </div>
                                ...
                                <div className="flex flex-row items-center gap-x-2.5 mt-1">
                                    ...
                                    <button className="text-sm p-2.5 border hover:bg-stone-700 focus:outline-none rounded bg-black text-white" onClick={() => {setEmailVerification(''); setEmailConfirmation('email-confirmed');}}>Verify</button>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="flex flex-col gap-y-1">
                        {twoSelect === "phone" && phoneVerification === 'phone-no' && (
                            <div>
                                ...
                                <div className="flex flex-row items-center gap-x-2.5">
                                    ...
                                    <button className="text-sm p-2.5 border hover:bg-stone-700 focus:outline-none rounded bg-black text-white" onClick={() => setPhoneVerification('phone-yes')}>Send Authentication Code</button>
                                </div>
                            </div>
                        )}
                        {twoSelect === "phone" && phoneVerification === 'phone-yes' && (
                            <div>
                                ...
                                <div className="flex flex-row items-center gap-x-2.5 mt-1">
                                    <input className="text-sm text-black border border-slate-400 rounded py-2.5 px-3 focus:outline-none" placeholder="XXXXXX" />
                                    <button className="text-sm p-2.5 border hover:bg-stone-700 focus:outline-none rounded bg-black text-white" onClick={() => {setPhoneVerification(''); setPhoneConfirmation('phone-confirmed');}}>Verify</button>
                                </div>
                            </div>
                        )}
