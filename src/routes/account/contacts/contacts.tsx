...
const items = [
    ...
    { id: 4, first: 'Yosemite', last: 'Sam', role: 'Business Analyst', phone: '(416) 440-7536', address: '75 West Wilmot Street', city: 'Toronto', province: 'ON', postal: 'L4B 1K7', email: 'yosemite.sam@cc.ca', web: 'Accounting Access' },
    { id: 5, first: 'Marvin', last: 'the Martian', role: 'Business Analyst', phone: '(416) 104-3642', address: '75 West Wilmot Street', city: 'Toronto', province: 'ON', postal: 'L4B 1K7', email: 'marvin.the.martian@cc.ca', web: 'Accounting Access'},
    { id: 6, first: 'Wile E.', last: 'Coyote', role: 'Business Analyst', phone: '(647) 412-0786', address: '75 West Wilmot Street', city: 'Toronto', province: 'ON', postal: 'L4B 1K7', email: 'wile.e.coyote@cc.ca', web: 'Accounting Access'},
