import { Plus, DotsThree, CreditCard, CaretDown, Pencil, Pen } from '@phosphor-icons/react';
...
const cards1 = [
    ...
    { id: 2,  image: mastercard, num: "**** **** **** 9374", expiry: "10/2024", default: "" },
    { id: 3,  image: mastercard, num: "**** **** **** 9375", expiry: "10/2025", default: "" },
]
                                    ...
                                    <div className="w-full">
                                        <div className="flex flex-row justify-between">
                                            ...
                                            <div className="flex flex-col gap-y-1">
                                                <div className="text-xs font-edmium w-16 flex justify-end">{card.default}</div>
